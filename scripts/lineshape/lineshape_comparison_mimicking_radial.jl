...
@tagsave(datadir("lineshape", "lineshape_comparison_mimicking_radial", savename(param1, "jld2")), result1)
@tagsave(datadir("lineshape", "lineshape_comparison_mimicking_radial", savename(param2, "jld2")), result2)
...
Plots.pdf(fig, plotsdir("lineshape", "lineshape_comparison_mimicking_radial", savename(param2)))
Plots.png(fig, plotsdir("lineshape", "lineshape_comparison_mimicking_radial", savename(param2)))
fig